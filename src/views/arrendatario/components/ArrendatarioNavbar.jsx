...
export function ArrendatarioNavbar() {
  ...
  const handleLogout = () => {
    ...
    navigate('/login') // Lo mandamos al login al cerrar sesión
  }
    ...
    <header className="bg-white border-b border-[#6B8E23]/10 sticky top-0 z-50">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          {/* Logo adaptado al rol de Anfitrión */}
          <button
            onClick={() => handleNavigation('/arrendatario')}
